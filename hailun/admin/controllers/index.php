...
class c_index extends SAdmin{
    ...
    function index($Path){
		...
		<li>官方广告: <span class="redb">'.APP_NAME.'[商业版] 仅售280元</span> (含永久免费升级及在线支持安装服务, 不含其它服务).</li>
		<li>销售QQ：<span class="redb">20577229</span>&nbsp;&nbsp;&nbsp; 您在使用'.APP_NAME.'[商业版]时有任何问题, 请访问: <a href="http://www.weentech.com/bbs/" target="_blank">闻泰网络BBS</a>!</li></ul>';
