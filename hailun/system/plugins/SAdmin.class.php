...
<div id="header">
	...
	<div id="topbar">
		<div id="topmenu">
			<dl class="first"></dl>
			<dl>
				<dt><a href="' . BURL('articles') . '">新闻</a></dt>
				<dd>
					<div>
						<li class="first"><a href="' . BURL('articles/add') . '">添加新闻</a></li>
						<li><a href="' . BURL('articles') . '">新闻列表</a></li>
						<li class="last"><a href="' . BURL('acategory') . '">新闻类别</a></li>
					</div>
				</dd>
			</dl>
			<dl>
...
<div id="sidebar">
	...
	<ul>
		...
		<li class="has-sub">
		   ...
		   <ul class="sub">
			  <li><a href="' . BURL('articles/add') . '">添加新闻</a></li>
			  <li><a href="' . BURL('articles') . '">新闻列表</a></li>
			  <li><a href="' . BURL('acategory') . '">新闻类别</a></li>
		   </ul>
		</li>
		<li class="has-sub">
		   <a href="#">
