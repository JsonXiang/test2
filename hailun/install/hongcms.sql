DROP TABLE IF EXISTS `hailun_pcat`;

CREATE TABLE `hailun_pcat` (
...
DROP TABLE IF EXISTS `hailun_product`;

CREATE TABLE `hailun_product` (
...
DROP TABLE IF EXISTS `hailun_gimage`;

CREATE TABLE `hailun_gimage` (
...
DROP TABLE IF EXISTS `hailun_acat`;

CREATE TABLE `hailun_acat` (
  `cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `p_id` int(11) NOT NULL DEFAULT '0',
  `sort` int(11) NOT NULL DEFAULT '0',
  `is_show` tinyint(1) NOT NULL DEFAULT '1',
...
DROP TABLE IF EXISTS `hailun_article`;

CREATE TABLE `hailun_article` (
...
DROP TABLE IF EXISTS `hailun_sessions`;

CREATE TABLE `hailun_sessions` (
...
DROP TABLE IF EXISTS `hailun_admin`;

CREATE TABLE `hailun_admin` (
...
DROP TABLE IF EXISTS `hailun_content`;

CREATE TABLE `hailun_content` (
...
INSERT INTO `hailun_content`  (`c_id`, `title`, `title_en`, `content`, `content_en`, `keywords`, `keywords_en`, `created`, `r_id`) VALUES 
...
DROP TABLE IF EXISTS `hailun_news`;

CREATE TABLE `hailun_news` (
...
DROP TABLE IF EXISTS `hailun_vvc`;

CREATE TABLE `hailun_vvc` (
