			...
			<div class="tab">
			    ...
			    <div class="z swiper-container swiper-no-swiping">
			        ...
			        <div class="swiper-slide Introduction">
			            	<div class="slideBox">
			            	<?php echo html($this->_tpl_vars['result']['0']['content']); ?>
<!-- 
			            	<div style="margin-top: 93px; padding: 0 104px 0 63px; float: left; padding-bottom: 145px;">
			            		<div class="img"><img src="<?php echo $this->_tpl_vars['t_url']; ?>images/Store_17.jpg" /></div>
...
的胸怀和执着的姿态，引领零部件产业与未来科技的不断发展。</p>
			            		<div class="img" style="margin-top: 94px; margin-bottom: 29px;"><img src="<?php echo $this->_tpl_vars['t_url']; ?>images/Store_38.jpg" /></div>
...
核心零部件研发、制造及服务提供商</p>
 ...
 -->
			            ...
			            <!--全球分布-->
			            <div class="swiper-slide distributed"><!-- <img style="margin-top: -27px;" class="z" src="<?php echo $this->_tpl_vars['t_url']; ?>images/map_02.jpg" /> --><?php echo html($this->_tpl_vars['result']['1']['content']); ?></div>
			            <!--文化理念-->
			            <div class="swiper-slide culture">
			            	<div class="slideBox">
			            		<!-- <h5 class="z" align="center">文化理念</h5>
			            		<div class="culture-l">
			            			<img src="<?php echo $this->_tpl_vars['t_url']; ?>images/culture_12.jpg" />
...
将企业发展成为全球化的汽车核心零部件研发、制造及服务提供商。</p>
			            			<img src="<?php echo $this->_tpl_vars['t_url']; ?>images/culture_30.jpg" />
			            		</div> -->
			            		<?php echo html($this->_tpl_vars['result']['2']['content']); ?>
			            	</div>
			            </div>
			            <!--领导团队-->
			            <div class="swiper-slide team">
			            	<div id="tim" class="slideBox">
					<?php echo html($this->_tpl_vars['result']['3']['content']); ?>
			            ...
			            <div class="swiper-slide trademark"><div class="slideBox">
			            	<ul class="z" id="conpany">
			            		<!-- <li><a><img src="<?php echo $this->_tpl_vars['t_url']; ?>images/trademark_17.jpg" /></a></li>  -->
			            		<?php echo html($this->_tpl_vars['result']['4']['content']); ?>
			            	</ul>
			        ...
			        <ul class="z swaper-tab">
			        	<li class="active"><?php echo $this->_tpl_vars['langs']['Introduction']; ?><em></em></li>
			        	<li><?php echo $this->_tpl_vars['langs']['global']; ?><em></em></li>
			        	<li><?php echo $this->_tpl_vars['langs']['Cultural']; ?><em></em></li>
			        	<li><?php echo $this->_tpl_vars['langs']['Team']; ?><em></em></li>
			        	<li><?php echo $this->_tpl_vars['langs']['partner']; ?><em></em></li>
			        </ul>
